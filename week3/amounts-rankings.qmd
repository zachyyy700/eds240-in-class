...
ca_region |> 
  ...
  mutate(subregion_name = fct_reorder(subregion_name, mean_sui_2010_2020)) |> 
  ggplot(aes(mean_sui_2010_2020, subregion_name)) +
  geom_col() +
...
ggplot(ca_region, aes(y = subregion_name)) +
  geom_bar() +
...
#......................% stacked bar chart.......................
ggplot(sui_severity, aes(month, tot_num_sui, fill = sui_category)) +
...
ggplot(sbc_subbasin_monthly) +
  ...
  geom_point(aes(x = mean_avail, y = month), color = "skyblue", size = 4, stroke = 2) +
  geom_point(aes(x = mean_consum, y = month), color = "firebrick", size = 4, shape = 21, stroke = 2) +
